...
/*Recibimos los valores de los formularios en variables */
        ...
        $sql = "INSERT INTO usuarios (usuario, password, tipo)  /*Pones los nombres de los campos en tu tabla */
...
/*Aqui es donde se muestra el mensaje de que se guarda el registro */
        ?>
            ...
            <div class="contenido">
                <button class="boton_regresar"><a href="AltaUsuarios.html">Regresar</a></button>
            </div>
        <?php
        } else {
        ?>
